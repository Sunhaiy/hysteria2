...
import type { PublicCatalog, PublicCatalogProduct } from "@/lib/seo";
...
function primaryOffer(product: PublicCatalogProduct) {
  return (
...
function yearlyValue(product: PublicCatalogProduct) {
