...
async function main() {
  await prisma.$transaction([
    ...
    prisma.epayRefundAttempt.deleteMany(),
    prisma.groupBuyMember.deleteMany(),
    prisma.groupBuy.deleteMany(),
    prisma.groupBuyCampaign.deleteMany(),
    prisma.dailyCheckIn.deleteMany(),
    prisma.epayPaymentAttempt.deleteMany(),
    prisma.epayGatewayTestAttempt.deleteMany(),
  ...
  await prisma.catalogProduct.createMany({
    data: [
      ...
      {
        id: 'system_group_buy_traffic_bonus',
        slug: 'system-group-buy-traffic-bonus',
        kind: 'TRAFFIC_PACK',
        series: 'STANDARD',
        status: 'DRAFT',
        name: '拼团赠送流量',
        description: '系统发放的拼团成功奖励',
        quotaCadence: 'ONE_TIME',
        speedUpMbps: 0,
        speedDownMbps: 0,
