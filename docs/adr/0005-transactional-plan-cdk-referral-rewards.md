# Settle referral rewards through qualifying paid plan transactions

Referral rewards are qualified only by a successful plan CDK redemption or a
verified Epay plan purchase and are settled in the same database transaction as
